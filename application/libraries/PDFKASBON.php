<?php 
    ...
    class PDFKASBON extends FPDF{
        ...
        function Header(){
            ...
            $this->Cell(95,10,'Kasbon','TB',0,'L');
            $this->Cell(25,10,'Nomor','LTB',0,'C');
            $this->Cell(5,10,':','TB',0,'C');
            $this->Cell(46,10,$idkasbon,'TB',1,'C');
            $this->Cell(10,5,'',0,1);
            
            $this->SetFont('Arial','B',10);
            $this->Cell(35,5,'Nama Karyawan',0,0,'L');
            $this->Cell(5,5,':',0,0,'L');
            $name = explode(" ", $namekasbon);
            $len_name = count($name);
            if($len_name>=3){
            ...
            $this->Cell(5,5,':',0,0,'L');
            $this->Cell(45,5,date('d-m-Y | H:i:s',strtotime($datesub)),0,1,'L');

            //Bagian Pengaju 
            $this->SetFont('Arial','',10);
            $this->Cell(35,5,'Cabang',0,0,'L');
            $this->Cell(5,5,':',0,0,'L');
            $this->Cell(72,5,$brNamekasbon,0,0,'L');

            //Bagian Total Reimburse 
            $this->Cell(35,5,'Divisi',0,0,'L');
            $this->Cell(5,5,':',0,0,'L');
            $this->Cell(45,5,$departNamekasbon,0,1,'L');

            //Bagian Pengaju 
            $this->Cell(35,5,'Tanggal Approve',0,0,'L');
            $this->Cell(5,5,':',0,0,'L');
            $this->Cell(72,5,date('d-m-Y | H:i:s',strtotime($appkasbon)),0,0,'L');

            //Bagian Total Reimburse 

            $this->Cell(35,5,'Tanggal Laporan',0,0,'L');
            $this->Cell(5,5,':',0,0,'L');
            $this->Cell(45,5,date('d-m-Y | H:i:s',strtotime($daterep)),0,1,'L');
            ...
            $this->SetFont('Arial','B',10);
            $this->Cell(6,6,'#',1,0);
            $this->Cell(95,6,'Keterangan',1,0,'L');
            $this->Cell(30,6,'Nominal Awal',1,0,'L');
            $this->Cell(30,6,'Nominal Lapor',1,0,'L');
            $this->Cell(30,6,'Selisih',1,1,'L');
