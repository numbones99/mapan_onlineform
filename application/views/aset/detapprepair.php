                    ...
                    <form role="form" action="<?php echo base_url().'Aset/accApp'?>" method="POST" enctype="multipart/form-data">  
                        <div class="card card-info">
                                        ...
                                        <table id="example3" class="table table table-bordered table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo base_url()?>assets/doc-repair/<?= $detail['DET_RP_PHOTO']; ?>" target="_blank"><img src="<?php echo base_url()?>assets/doc-repair/<?= $detail['DET_RP_PHOTO']; ?>" width="75px"></a></td>
                                                </tr>
                                                <?php endforeach;?>
                                            </tbody>
                                        </table>
                            ...
                            <div class="card-footer">
                                ...
                                ?>
                                <div class="col-md-6">
                                        <button type="button" data-toggle="modal" data-target="#modal-jadwal" class="btn btn-block btn-success">
                                            Jadwalkan Visit
                                        </button>
                                    </div>
                                    <div class="col-md-6">
                                        <button type="button" data-toggle="modal" data-target="#modal-deny" class="btn btn-block btn-danger">
                                            Tolak Pengajuan
                                        </button>
                                    </div>
                                <?php } ?>
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <form role="form" action="<?php echo base_url().'Aset/accApp'?>" method="POST" enctype="multipart/form-data">
                                        <div class="modal-header text-center" style="background-color:#5cb85c;color:white;">
                                            <h5 class="modal-title text-center">Atur Jadwal Perbaikan</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        ...
                                        <div class="row">
                                                <div class="col-md-12">
                                                <label>Pilih Tanggal Mulai Sampai Selesai</label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                        <span class="input-group-text"><i class="far fa-clock"></i></span>
                                                        </div>
                                                        <input type="hidden" name='repairid' class="form-control" value="<?= $nama['RP_ID']?>" readonly>
                                                        <input type="text" name="insTgl" class="form-control float-right" id="reservationtime">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                            <button type="submit" formaction="<?php echo base_url().'Aset/accApp'?>" class="btn btn-success">Lanjutkan</button>
                                        </div>
                                    </form>
                                    </div>
                                    <!-- /.modal-content -->
                            ...
                            <div class="modal fade" id="modal-acc">
                                <div class="modal-dialog modal-lg">
                                    ...
                                    <form role="form" action="<?php echo base_url().'Aset/accApp'?>" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                            <button type="submit" formaction="<?php echo base_url().'Aset/accAppFinal'?>" class="btn btn-success">Lanjutkan</button>
                                        </div>
                                    </form>
                                    </div>
                                    <!-- /.modal-content -->
                            ...
                            <div class="modal fade" id="modal-deny">
                                    <div class="modal-dialog modal-dialog-centered">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                            <button type="submit" formaction="<?php echo base_url().'Aset/accDeny'?>" class="btn btn-danger">Lanjutkan</button>
                                        </div>
                                        </div>
                                        <!-- /.modal-content -->
                                    </div>
